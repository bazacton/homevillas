...
if (!class_exists('Wp_rem_Favourites')) {
    ...
    class Wp_rem_Favourites {
        ...
        public function init() {
            ...
            add_action('wp_rem_property_favourite_button_frontend', array($this, 'wp_rem_property_favourite_button_callback'), 11, 3);
        ...
        public function favourites_top_menu_member_dashboard_callback($wp_rem_page_id, $icon = '', $favourite_url = '') {
            ...
            if (isset($favourite_url) && $favourite_url <> '') {
                ...
                echo ' <li class="user_dashboard_ajax" id="wp_rem_member_favourites" data-queryvar="dashboard=favourites"><a href="javascript:void(0);">' . $icon . $wp_rem_page_id . '</a></li>';
            }
        }
        ...
        public function wp_rem_favourites_member_permissions_callback($permissions = array()) {
         ...
         */
        public function wp_rem_property_favourite_button_callback($post_id = '', $args = array(), $figcaption_div = false) {
            wp_enqueue_script('wp-rem-favourites-script');
            $before_html = '';
            $after_html = '';
            $before_label = '';
        ...
        public function wp_rem_favourites_frontend_button_callback($post_id = '', $args = array(), $figcaption_div = false) {
            ...
            if ($user_id != 0 && $post_id != '') {
                ...
                if (true === Wp_rem_Member_Permissions::check_permissions('favourites')) {
                        if (isset($figcaption_div) && $figcaption_div == true) { echo '<li><div class="like-btn">'; } ?>
                        ...
                        <?php
                        if (isset($figcaption_div) && $figcaption_div == true) { echo '</div></li>'; }  
                }
            } else {
                if (isset($figcaption_div) && $figcaption_div == true) { echo '<li><div class="like-btn">'; }
                ?>
                        ...
                        if (isset($before_signin_callback) && $before_signin_callback === true) {
                            $signin_call_back = ' onclick="wp_rem_open_signin_model()"';
                        }
                        ?>
                        <a href="javascript:void(0);" class="<?php echo esc_html($class); ?> wp-rem-open-signin-tab"<?php echo ($signin_call_back) ?>>
                            <?php echo $favourite_icon; ?><?php echo esc_html($favourite_text); ?>
                        </a>
                <?php
                if (isset($figcaption_div) && $figcaption_div == true) { echo '</div></li>'; }  
        ...
        public function wp_rem_favourite_submit_callback() {
            ...
            if ('' != $member_id) {
                ...
                $member_name = '<a href="' . get_the_permalink($user_company) . '">' . $member_name . '</a>';
                ...
                if (!empty($member_favourites) && $this->wp_rem_favourites_find_in_multiarray($property_id, $member_favourites, 'property_id')) {
                    ...
                    $notification_array = array(
                        ...
                        'message' => force_balance_tags($member_name . ' ' . wp_rem_plugin_text_srt('wp_rem_favourite_remove_one_list') . ' <a href="' . get_the_permalink($property_id) . '">' . wp_trim_words(get_the_title($property_id), 3) . '</a>'),
                    );
        ...
        public function wp_rem_favourites_find_in_multiarray($elem, $array = array(), $field = '') {
