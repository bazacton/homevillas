                    ...
                    <form id="frm" method="post">
                        ...
                        <div class="col1">
                            <nav class="admin-navigtion">
                                ...
                                <ul>
                                    <?php echo wp_rem_cs_allow_special_char($return[1], true); ?>
                                </ul>
                            </nav>
                        </div>

                        <div class="col2">
                            <?php echo wp_rem_cs_allow_special_char($return[0], true); ?>
                        </div>
                        <?php
...
if ( ! function_exists('wp_rem_cs_var_options_array') ) {
    ...
    function wp_rem_cs_var_options_array() {
        ...
        if ( (isset($wp_rem_cs_var_options['wp_rem_cs_var_sidebar']) && is_array($wp_rem_cs_var_options['wp_rem_cs_var_sidebar'])) && count($wp_rem_cs_var_options['wp_rem_cs_var_sidebar']) > 0 ) {
        ...
        $wp_rem_cs_var_settings[] = array(
            ...
            "label_desc" =>  wp_rem_cs_var_theme_text_srt('wp_rem_header_full_width_hint'),
            "id" => "header_full_width",
            "std" => "off",
            "type" => "checkbox"
        );
        ...
        $wp_rem_cs_var_settings[] = array( "name" => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_theme_option_footer_social_icon_switch'),
            "desc" => "",
            "label_desc" => '',
        ...
        $wp_rem_cs_var_settings[] = array( 
            "name" => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_theme_skin'),
            "desc" => "",
            "label_desc" => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_theme_skin_hint'),
            "id" => "theme_skin_style",
            "std" => "",
            "type" => "select",
            'classes' => 'chosen-select',
            "options" => array(
                '' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_theme_skin_default'),
                'dark' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_theme_skin_dark'),
            )
        );
        ...
        $wp_rem_cs_var_settings[] = array( "name" => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_footer_border_color'),
            "desc" => "",
            "label_desc" => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_footer_border_color_hint'),
...
//        );
        ...
        $wp_rem_cs_var_settings[] = array( "name" => wp_rem_cs_var_theme_text_srt('wp_rem_theme_option_marketplace_token'),
            "desc" => "",
            "label_desc" => wp_rem_cs_var_theme_text_srt('wp_rem_theme_option_marketplace_token_hint'),
            "id" => "cs_marketplace_token",
            "std" => "",
            "type" => "text" );
        $wp_rem_cs_var_settings[] = array( "name" => wp_rem_cs_var_theme_text_srt('wp_rem_theme_option_secret_item_id'),
            "desc" => "",
            "label_desc" => wp_rem_cs_var_theme_text_srt('wp_rem_theme_option_item_id_hint'),
            "id" => "cs_item_id",
            "std" => "",
            "type" => "text" );
