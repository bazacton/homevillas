...
if (!class_exists('wp_rem_real_estate_framework')) {
    ...
    class wp_rem_real_estate_framework {
        ...
        public function __construct() {
            ...
            add_action('admin_init', array( $this, 'wp_rem_theme_identifier' ), 0);
        ...
        public function wp_rem_theme_identifier() {
            if ( wp_rem_real_estate_framework::$theme_identify != 'wp-rem-real-estate' ) {
                deactivate_plugins(plugin_basename(__FILE__));
                $this->admin_notice = wp_rem_cs_var_frame_text_srt( 'wp_rem_plugin_error' );
                add_action('admin_notices', array($this, 'wp_rem_admin_notices_callback'));
            }
        }
        
        public function wp_rem_admin_notices_callback(){
