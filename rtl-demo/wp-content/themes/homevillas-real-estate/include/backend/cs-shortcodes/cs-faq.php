...
if (!function_exists('wp_rem_cs_var_page_builder_faq')) {
    ...
    function wp_rem_cs_var_page_builder_faq($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_cs_var_faq_title_color'=>'',
                'wp_rem_cs_var_faq_subtitle_color'=>'',
             'wp_rem_var_faq_seperator_style'=> '',
        );
        ...
        $wp_rem_cs_var_faq_title_color = isset( $wp_rem_cs_var_faq_title_color ) ? $wp_rem_cs_var_faq_title_color : '';
    $wp_rem_cs_var_faq_subtitle_color = isset( $wp_rem_cs_var_faq_subtitle_color ) ? $wp_rem_cs_var_faq_subtitle_color : '';
        ...
        <div id="<?php echo wp_rem_cs_allow_special_char($name . $wp_rem_cs_counter) ?>_del" class="column  parentdelete <?php echo wp_rem_cs_allow_special_char($coloumn_class); ?> <?php echo wp_rem_cs_allow_special_char($shortcode_view); ?>" item="faq" data="<?php echo wp_rem_cs_element_size_data_array_index($faq_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_counter) ?> <?php echo wp_rem_cs_allow_special_char($shortcode_element); ?>" id="<?php echo wp_rem_cs_allow_special_char($name . $wp_rem_cs_counter) ?>" data-shortcode-template="[<?php echo esc_attr('wp_rem_cs_faq'); ?> {{attributes}}]" style="display: none;">
                    ...
                    <div class="cs-wrapp-tab-box">
                        <div id="shortcode-item-<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_counter); ?>" data-shortcode-template="{{child_shortcode}}[/<?php echo esc_attr('wp_rem_cs_faq'); ?>]" data-shortcode-child-template="[<?php echo esc_attr('faq_item'); ?> {{attributes}}] {{content}} [/<?php echo esc_attr('faq_item'); ?>]">
                            <div class="cs-wrapp-clone cs-shortcode-wrapp cs-disable-true cs-pbwp-content" data-template="[<?php echo esc_attr('wp_rem_cs_faq'); ?> {{attributes}}]">
                                ...
                                $wp_rem_cs_opt_array = array(
                                    'name' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_element_title_color'),
                                    'desc' => '',
                                    'hint_text' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_element_title_color_hint'),
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_faq_title_color),
                                        'cust_name' => 'wp_rem_cs_var_faq_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    'name' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_element_subtitle_color'),
                                    'desc' => '',
                                    'hint_text' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_element_subtitle_color_hint'),
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_faq_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_faq_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_opt_array = array(
                    'name' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_element_title_seperator'),
                    'desc' => '',
                    'hint_text' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_element_title_seperator_hint'),
                    'echo' => true,
                    'field_params' => array(
                        'std' => $wp_rem_var_faq_seperator_style,
                        'id' => '',
                        'cust_name' => 'wp_rem_var_faq_seperator_style[]',
                        'classes' => 'chosen-select-no-single',
                        'options' => array(
                            '' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_element_title_seperator_none'),
                            'classic' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_element_title_seperator_classic'),
                            'zigzag' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_element_title_seperator_zigzag'),
                        ),
                        'return' => true,
                    ),
                );
...
do_action('wp_rem_shortcode_fields_render', $output, array('responsive_fields' => true));
    ...
    function wp_rem_cs_save_page_builder_data_faq_callback($args) {
        ...
        if ($widget_type == "faq" || $widget_type == "cs_faq") {
            ...
            if (isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode') {
                ...
                if (isset($data['wp_rem_cs_var_faq_subtitle_color'][$counters['wp_rem_cs_counter_faq']]) && $data['wp_rem_cs_var_faq_subtitle_color'][$counters['wp_rem_cs_counter_faq']] != '') {
                    $section_title .= 'wp_rem_cs_var_faq_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_faq_subtitle_color'][$counters['wp_rem_cs_counter_faq']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_cs_var_faq_title_color'][$counters['wp_rem_cs_counter_faq']]) && $data['wp_rem_cs_var_faq_title_color'][$counters['wp_rem_cs_counter_faq']] != '') {
                    $section_title .= 'wp_rem_cs_var_faq_title_color="' . htmlspecialchars($data['wp_rem_cs_var_faq_title_color'][$counters['wp_rem_cs_counter_faq']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_var_faq_seperator_style'][$counters['wp_rem_cs_counter_faq']]) && $data['wp_rem_var_faq_seperator_style'][$counters['wp_rem_cs_counter_faq']] != '') {
                    $section_title .= 'wp_rem_var_faq_seperator_style="' . htmlspecialchars($data['wp_rem_var_faq_seperator_style'][$counters['wp_rem_cs_counter_faq']], ENT_QUOTES) . '" ';
                }
                ...
                $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $section_title, $data, $counters['wp_rem_cs_counter_faq'], array( 'responsive_atts' => true ));
