                ...
                foreach ($wp_rem_cs_var_settings as $value) {
                    ...
                    switch ($value['type']) {
                            ...
                            if (isset($value['enable_val'])) {
                                ...
                                if (is_array($enable_multi) && sizeof($enable_multi) > 1) {
                                    ...
                                    if ($enable_id == 'wp_rem_cs_var_header_full_width') {
                                        echo wp_rem_cs_allow_special_char($d_val);
                                        echo wp_rem_cs_allow_special_char($enable_val);
                                    }
                        ...
                        case "announcement":
                            ...
                            $output.='<div id="' . $value['id'] . '" class="sidebar-area theme-help">
											...
											<h4>' . wp_rem_cs_allow_special_char($value['name']) . '</h4>
											<p>' . wp_rem_cs_allow_special_char($value['std']) . '</p>
								 </div>';
                            break;

                        case "section":
                            $output .='<div class="theme-help">
									<h4>' . wp_rem_cs_allow_special_char($value['std']) . '</h4>
									<div class="clear"></div>
								  </div>';
                            break;
                                ...
                                foreach ($network_list as $network) {
                                    if (isset($network_list[$i]) || isset($network_list[$i])) {
                                        ...
                                        if (isset($banner_image[$i]) && !empty($banner_image[$i]) && $banner_type[$i] == 'image') {
                                            $output .= '<td><img src="' . esc_url($banner_image[$i]) . '" alt="img" width="100" /></td>';
                                        } else {
					...
					<div class="radio-image-wrapper">';
                        ...
                        case 'gfont_select':
                            ...
                            $wp_rem_cs_var_custom_fonts = '';
                            if (class_exists('wp_rem_google_fonts_admin')) {
                                $wp_rem_google_fonts_admin = new wp_rem_google_fonts_admin();
                                $wp_rem_cs_var_custom_fonts = $wp_rem_google_fonts_admin->wp_rem_selected_custom_fonts_list();
                            }
                    ...
                    <ul class="wp-rem-list-layout">
                        ...
                        case "wp_rem_cs_var_footer_sidebar":
                            ...
                            if (isset($wp_rem_cs_var_options['wp_rem_cs_var_footer_sidebar']) and is_array($wp_rem_cs_var_options['wp_rem_cs_var_footer_sidebar']) && count($wp_rem_cs_var_options['wp_rem_cs_var_footer_sidebar']) > 0) {
                                $val['wp_rem_cs_var_footer_sidebar'] = $wp_rem_cs_var_options['wp_rem_cs_var_footer_sidebar'];
                            }

                            if (isset($wp_rem_cs_var_options['wp_rem_cs_var_footer_width']) and is_array($wp_rem_cs_var_options['wp_rem_cs_var_footer_width']) && count($wp_rem_cs_var_options['wp_rem_cs_var_footer_width']) > 0) {
                            ...
                            if (isset($val['wp_rem_cs_var_footer_width']) && is_array($val['wp_rem_cs_var_footer_width']) and count($val['wp_rem_cs_var_footer_width']) > 0 and $val['wp_rem_cs_var_footer_width'] <> '') {
                                $display = 'block';
                            } else {
                                $display = 'none';
                            }
                            ...
                            wp_rem_cs_admin_inline_enqueue_script($wp_rem_cs_inline_script, 'wp_rem_cs-custom-functions');
                            $i = 0;
                            if (isset($val['wp_rem_cs_var_footer_sidebar']) && is_array($val['wp_rem_cs_var_footer_sidebar']) && count($val['wp_rem_cs_var_footer_sidebar']) > 1) {
